...
export async function updateMedicineBatch(medicineId, batchId, data) {
  const res = await api.patch(`/medicines/${medicineId}/batches/${encodeURIComponent(batchId)}`, data)
  return res.data?.data
}
