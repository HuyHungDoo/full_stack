...
export default function Inventory() {
  ...
  const inventorySummary = useMemo(() => {
    ...
    return {
      totalMedicines: filteredData.length || medicineMeta?.total || 0,
      totalBatches: medicineMeta?.total || filteredData.length || 0,
      lowStock: 0,
      expiredBatches: 0,
      expiringBatches: 0,
    }
  }, [filteredData.length, inventoryStats, medicineMeta])
